...
def stm_relative_target(row):
    ...
    return stm_cp / CP_SCALE


def build(input_globs, out_path, val_fraction, seed):
    rows = []
    ...
    for row in rows:
        ...
        targets.append(stm_relative_target(row))
...
def main():
    ...
    build(args.input, args.out, args.val_fraction, args.seed)
